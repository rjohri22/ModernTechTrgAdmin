		...
		<form action="{{route('admin.update_oppertunity',$oppertunity->id)}}" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<textarea type="text" name="profile" class="form-control ckeditor" rows="8" value="">{{$oppertunity->profile}}</textarea>
				</div>
				<div class="col-sm-12">
					<label>Responsibilities</label>
					<textarea type="text" name="Responsibilities" id="" class="form-control ckeditor" rows="8" >{{$oppertunity->Responsibilities}}</textarea>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-sm-12">
					<label>KPI</label>
					<textarea class="form-control ckeditor" name="summery" rows="8">{{$oppertunity->summery}}</textarea>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-sm-12">
					...
					<textarea class="form-control ckeditor" name="description" rows="8">{{$oppertunity->description}}</textarea>
				</div>
			</div>
			<br>
			<div class="row">
