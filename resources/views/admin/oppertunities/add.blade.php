			...
			<div class="card-body">
				<form action="{{url('admin/oppertunities/store_oppertunity')}}" method="post">
					...
					<div class="row">
						<div class="col-sm-12">
							<label>Daily Job</label>
							<textarea type="text" name="daily_job" id="editor1" class="form-control" rows="8"></textarea>
						</div>
					</div>
					<!-- <div class="row">
					<div class="col-sm-12">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<textarea type="text" name="Responsibilities" id="editor2" class="form-control editor1" rows="8" ></textarea>
						</div>
					</div>
					<br>
