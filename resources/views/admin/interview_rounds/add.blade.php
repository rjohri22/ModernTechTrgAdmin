...
<script>
    $(document).ready(function(){
        ...
        $('#questionsModal').on('click','#editRound',function(){
            ...
            // html += "<tr>";
            //     html += "<input type='hidden' name='round_id[]' value='"+round_id+"' >";
            //     html += "<input type='hidden' name='round_questions[]' value='"+ids+"' >";
            //     html += "<td>"+round_name+"</td>";
            //     html += "<td>"+noofquestion+"</td>";
            //     html += "<td>";
            //         html += "<button type='button' class='btn btn-sm btn-primary roundEdit' data-rid='"+round_id+"' data-questions='"+ids+"'  data-bs-toggle='modal' data-bs-target='#questionsModal' >Edit</button>";
            //     html += "</td>";
            // html += "</tr>";
            // $('#selectRoundTable tbody').append(html);
