...
class JobSeekerController extends AdminBaseController {
    ...
    public function index(){
        ...
        $this->data['job_seeker'] = $fetch;
        return view('admin/job_seekers/index',$this->data);
    }
    public function add(){
        $this->loadBaseData();
        if(!$this->check_role()){
        ...
        return view('admin/job_seekers/add',$this->data);
    }
    public function edit($id){
        ...
        $this->data['business'] = Companies::get();
        $this->data['countries'] = Countries::get();
        return view('admin/job_seekers/edit',$this->data);
    }
    ...
    public function view($id){
        ...
        $this->data['certificate'] = Employee_cirtificates::where('user_id', $id)->get();
        $this->data['links'] = Employee_sociallinks::where('user_id', $id)->get();
        return view('admin/job_seekers/view',$this->data);
    }
